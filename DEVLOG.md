...
- Created Tasks Django application
- Designed Task model from scratch using documentation
- Added relations to User model
- Generator a migration
- Applied the migration

## Learned

- Difference between makemigrations and migrate
- How Django ORM creates database schema
...
- Git commit messages should be more specific
